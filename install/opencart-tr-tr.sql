...
VALUES ('1', 'Türk Lirası', 'TRY', '', '₺', '2', '1.00000000', '1', '2026-08-27 20:24:29'),
       ('2', 'US Dollar', 'USD', '$', '', '2', '0.02077672', '1', '2026-08-27 20:24:29'),
       ('3', 'Euro', 'EUR', '', '€', '2', '0.01784175', '1', '2026-08-27 20:24:29');
...
INSERT INTO `oc_setting` (`code`, `key`, `value`, `serialized`)
VALUES ('config', 'config_name', 'OpenCore', '0'),
       ('config', 'config_logo', 'catalog/opencart-logo.png', '0'),
       ('config', 'config_icon', 'catalog/profile-pic.png', '0'),
       ('config', 'config_owner', 'Firma Ünvanı', '0'),
       ('config', 'config_address', 'Adres', '0'),
       ('config', 'config_geocode', '', '0'),
       ('config', 'config_email', '', '0'),
       ('config', 'config_telephone', '123456789', '0'),
       ('config', 'config_open', '', '0'),
       ('config', 'config_comment', '', '0'),
       ('config', 'config_country_id', '215', '0'),
       ('config', 'config_zone_id', '3354', '0'),
       ('config', 'config_timezone', 'Europe/Istanbul', '0'),
       ('config', 'config_language_catalog', 'tr-tr', '0'),
       ('config', 'config_language_admin', 'tr-tr', '0'),
       ('config', 'config_currency', 'TRY', '0'),
       ...
       ('config', 'config_image_thumbnail_height', '160', '0'),
       ('config', 'config_image_icon_width', '64', '0'),
       ('config', 'config_image_icon_height', '64', '0'),
       ('config', 'config_image_popup_width', '800', '0'),
       ('config', 'config_image_popup_height', '800', '0'),
       ...
       ('config', 'config_user_2fa', '0', '0'),
       ('config', 'config_2fa_expire', '90', '0'),
       ('config', 'config_user_password_length', '', '0'),
...
VALUES ('1', 'currency', 'Updates currency conversion values.', 'day', 'cron/currency', '1', '2014-09-25 14:40:00', '2026-08-24 18:06:34'),
       ('2', 'notification_cleanup', 'Süresi dolan bildirimleri kaldırır.', 'day', 'cron/notification_cleanup', '1', '2026-08-31 00:00:00', '2026-08-31 00:00:00');
