<?php
namespace Opencart\App\Controller\Mail;
/**
 * Class Authorize
 *
 * @package Opencart\App\Controller\Mail
 */
class Authorize extends \Opencart\System\Engine\Controller {
	/**
	 * Index
	 *
	 * app/controller/common/authorize.send/after
	 *
	 * @param string            $route
	 ...
	 * Reset
	 *
	 * app/model/user/user.addToken/after
	 *
	 * @param string            $route
	 * @param array<int, mixed> $args
	 * @param array<mixed>      $output
